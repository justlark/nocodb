...
export class CommentsV3Controller {
  ...
  @Get(`${PREFIX_APIV3_META}/tables/:tableId/records/:rowId/comments`)
  @Acl('commentList')
  async commentList(
  ...
  @Post(`${PREFIX_APIV3_META}/tables/:tableId/records/:rowId/comments`)
  @HttpCode(200)
  @Acl('commentRow')
  async commentRow(
    @TenantContext() context: NcContext,
  ...
  @Delete(`${PREFIX_APIV3_META}/comment/:commentId`)
  @Acl('commentDelete')
  async commentDelete(
    @TenantContext() context: NcContext,
    @Req() req: NcRequest,
  ...
  @Patch(`${PREFIX_APIV3_META}/comment/:commentId`)
  @Acl('commentUpdate')
  async commentUpdate(
    @TenantContext() context: NcContext,
    @Param('commentId') commentId: string,
